...
/**
 * Subset of the data needed to advance a Shipment's status / log an action.
 * Mirrors the action log payload used by `persistShipmentAction` in
 * `@/lib/freightflow-data`.
 */
